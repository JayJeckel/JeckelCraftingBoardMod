...
public class BlockColoredCraftingBoard extends BlockMetaColored implements IBlockGuiActivator
{
	public BlockColoredCraftingBoard()
	{
		super(Material.wood);
		this.setLightOpacity(0);
		this.setHardness(2.5F);
		this.setStepSound(Block.soundTypeWood);
		this.setBlockName("crafting_board_colored");
	...
	@SideOnly(Side.CLIENT)
	@Override public IIcon getIcon(int side, int meta) { return (side == 1 ? this.blockIconTop : super.getIcon(side, meta)); }
