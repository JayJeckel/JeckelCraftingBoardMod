...
import jeckelcraftingboardmod.content.ContentManager;
...
public class Refs
{
	public static final String ModId = "jeckelcraftingboardmod";
	public static final String ModName = "JeckelCraftingBoardMod";
